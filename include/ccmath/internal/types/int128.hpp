...
// Code modified for use by ccmath
...
namespace ccm
{
	...
	// the `CCM_HAVE_INTRINSIC_INT128` macro.)
	//
	...
	//
	class
#if defined(CCM_HAVE_INTRINSIC_INT128)
		alignas(unsigned __int128)
#endif  // CCM_HAVE_INTRINSIC_INT128
			uint128 {
	public:
		uint128() = default;
...
#ifdef CCM_HAVE_INTRINSIC_INT128
...
#ifndef CCM_NUMERIC_INT128_H_
#define CCM_NUMERIC_INT128_H_
