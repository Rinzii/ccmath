...
struct simd<float, abi::avx>
{
	...
	[[nodiscard]] constexpr __m256 get() const { return m_value; }
	[[nodiscard]] CCM_ALWAYS_INLINE inline float convert() const
	{
...
CCM_ALWAYS_INLINE inline simd<float, abi::avx> choose(simd_mask<float, abi::avx> const & a, simd<float, abi::avx> const & b, simd<float, abi::avx> const & c)
{
...
public:
	...
	[[nodiscard]] CCM_ALWAYS_INLINE inline double convert() const
	{
