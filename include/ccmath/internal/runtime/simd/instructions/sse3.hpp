...
namespace ccm::intrin
{
	...
	CCM_ALWAYS_INLINE inline bool all_of(simd_mask<float, abi::sse3> const & a)
	{
		return _mm_movemask_ps(a.get()) == 0xF;
	}

	CCM_ALWAYS_INLINE inline bool any_of(simd_mask<float, abi::sse3> const & a)
	{
	...
	struct simd<float, abi::sse3>
	{
		...
		CCM_ALWAYS_INLINE simd_mask<float, abi::sse3> operator<(simd const & other) const
		{
			return simd_mask<float, abi::sse3>(_mm_cmplt_ps(m_value, other.m_value));
		}
		CCM_ALWAYS_INLINE simd_mask<float, abi::sse3> operator==(simd const & other) const
		{
			return simd_mask<float, abi::sse3>(_mm_cmpeq_ps(m_value, other.m_value));
		}
	...
	CCM_ALWAYS_INLINE inline simd<float, abi::sse3> choose(simd_mask<float, abi::sse3> const & a, simd<float, abi::sse3> const & b,
	...
	CCM_ALWAYS_INLINE inline bool all_of(simd_mask<double, abi::sse3> const & a)
	{
		return _mm_movemask_pd(a.get()) == 0x3;
	}

	CCM_ALWAYS_INLINE inline bool any_of(simd_mask<double, abi::sse3> const & a)
	{
	...
	struct simd<double, abi::sse3>
	{
		...
		CCM_ALWAYS_INLINE inline simd_mask<double, abi::sse3> operator<(simd const & other) const
		{
			return simd_mask<double, abi::sse3>(_mm_cmplt_pd(m_value, other.m_value));
		}
		CCM_ALWAYS_INLINE inline simd_mask<double, abi::sse3> operator==(simd const & other) const
		{
			return simd_mask<double, abi::sse3>(_mm_cmpeq_pd(m_value, other.m_value));
		}
	...
	CCM_ALWAYS_INLINE inline simd<double, abi::sse3> choose(simd_mask<double, abi::sse3> const & a, simd<double, abi::sse3> const & b,
