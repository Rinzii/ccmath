...
namespace ccm::intrin
{
	...
	template <>
	struct simd_mask<float, abi::sse4>
	{
	...
	CCM_ALWAYS_INLINE inline bool all_of(simd_mask<float, abi::sse4> const & a)
	{
		return _mm_movemask_ps(a.get()) == 0xF;
	}

	CCM_ALWAYS_INLINE inline bool any_of(simd_mask<float, abi::sse4> const & a)
	{
		return _mm_movemask_ps(a.get()) != 0x0;
	}

	template <>
	struct simd<float, abi::sse4>
	{
	...
	CCM_ALWAYS_INLINE inline simd<float, abi::sse4> choose(simd_mask<float, abi::sse4> const & a, simd<float, abi::sse4> const & b,
														   simd<float, abi::sse4> const & c)
	{
	...
	template <>
	struct simd_mask<double, abi::sse4>
	{
		using value_type					 = bool;
	...
	CCM_ALWAYS_INLINE inline bool all_of(simd_mask<double, abi::sse4> const & a)
	{
		return _mm_movemask_pd(a.get()) == 0x3;
	}

	CCM_ALWAYS_INLINE inline bool any_of(simd_mask<double, abi::sse4> const & a)
	{
		return _mm_movemask_pd(a.get()) != 0x0;
	}

	template <>
	struct simd<double, abi::sse4>
	{
		...
		CCM_ALWAYS_INLINE inline simd_mask<double, abi::sse4> operator<(simd const & other) const
		{
	...
	CCM_ALWAYS_INLINE inline simd<double, abi::sse4> choose(simd_mask<double, abi::sse4> const & a, simd<double, abi::sse4> const & b,
