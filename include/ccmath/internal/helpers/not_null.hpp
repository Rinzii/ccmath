...
#ifndef CCM_POINTERS_H
#define CCM_POINTERS_H
...
{
	template <class T>
	struct hash<ccm::helpers::not_null<T>> : ccm::helpers::not_null_hash<ccm::helpers::not_null<T>>
	{
	};
...
{
	template <class T>
	struct hash<ccm::helpers::strict_not_null<T>> : ccm::helpers::not_null_hash<ccm::helpers::strict_not_null<T>>
	{
	};

} // namespace std

#endif // CCM_POINTERS_H
