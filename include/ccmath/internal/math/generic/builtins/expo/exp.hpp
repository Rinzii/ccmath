...
namespace ccm::builtin
{
	...
	/**
	 * Wrapper for constexpr __builtin exp functions.
	 * This should be used internally and always be wrapped in an if constexpr statement.
	 * It exists only to allow for usage of __builtin exp functions without triggering a compiler error
