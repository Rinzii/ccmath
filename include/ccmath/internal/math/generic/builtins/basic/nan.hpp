...
/// CCMATH_HAS_CONSTEXPR_BUILTIN_NAN
...
namespace ccm::builtin
{
	...
	/**
	 * Wrapper for constexpr __builtin nan functions.
	 * This should be used internally and always be wrapped in an if constexpr statement.
	 * It exists only to allow for usage of __builtin nan functions without triggering a compiler error
