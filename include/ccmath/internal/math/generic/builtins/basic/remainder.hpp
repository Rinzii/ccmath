...
namespace ccm::builtin
{
	...
	/**
	 * Wrapper for constexpr __builtin remainder functions.
	 * This should be used internally and always be wrapped in an if constexpr statement.
	 * It exists only to allow for usage of __builtin remainder functions without triggering a compiler error
	 * when the compiler does not support them.
	 */
	template <typename T>
	constexpr auto remainder(T x, T y) -> std::enable_if_t<has_constexpr_remainder<T>, T>
	{
