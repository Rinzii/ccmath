...
namespace ccm::builtin
{
	// clang-format off
	template <typename T>
	inline constexpr bool has_constexpr_sqrt =
#ifdef CCMATH_HAS_CONSTEXPR_BUILTIN_SQRT
	...
	/**
	 * Wrapper for constexpr __builtin sqrt functions.
	 * This should be used internally and always be wrapped in an if constexpr statement.
	 * It exists only to allow for usage of __builtin sqrt functions without triggering a compiler error
