...
namespace ccm::gen::impl
{
	namespace internal::impl
	{
		...
		inline constexpr std::array<double, 7> POW_LOG2_COEFFS = {
			0x1.71547652b82fep0,
			-0x1.71547652b82e7p-1,
			0x1.ec709dc3b1fd5p-2,
			-0x1.7154766124215p-2,
			0x1.2776bd90259d8p-2,
			-0x1.ec586c6f3d311p-3,
		...
		constexpr double pow_double_double(unsigned idx_x, double dx, double e_x, double y6, std::uint64_t sign,
										   double scale) noexcept // NOLINT(bugprone-exception-escape)
		{
			using FPBits_t = support::fp::FPBits<double>;
