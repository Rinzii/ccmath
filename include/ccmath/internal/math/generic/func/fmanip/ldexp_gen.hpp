...
namespace ccm
{
	 ...
	 * \note On many implementations, std::ldexp is less efficient than multiplication or division by a power of two using arithmetic operators.
	 * \tparam T A floating-point type or an integer type.
