...
namespace ccm::pp
{
	...
	template <std::size_t B, typename Abi> CCM_ALWAYS_INLINE bool all_of(basic_simd_mask<B, Abi> const & mask)
	{
		return SimdTraits<detail::mask_integer_from<B>, Abi>::all_of(mask.get());
	}
	template <std::size_t B, typename Abi> CCM_ALWAYS_INLINE bool any_of(basic_simd_mask<B, Abi> const & mask)
	{
		return SimdTraits<detail::mask_integer_from<B>, Abi>::any_of(mask.get());
	}
	template <std::size_t B, typename Abi> CCM_ALWAYS_INLINE bool none_of(basic_simd_mask<B, Abi> const & mask)
	{
		return !SimdTraits<detail::mask_integer_from<B>, Abi>::any_of(mask.get());
	}
	template <std::size_t B, typename Abi> CCM_ALWAYS_INLINE detail::SimdSizeType reduce_count(basic_simd_mask<B, Abi> const & mask)
	{
	...
	template <std::size_t B, typename Abi> CCM_ALWAYS_INLINE detail::SimdSizeType reduce_min_index(basic_simd_mask<B, Abi> const & mask)
	{
	...
	template <std::size_t B, typename Abi> CCM_ALWAYS_INLINE detail::SimdSizeType reduce_max_index(basic_simd_mask<B, Abi> const & mask)
	{
