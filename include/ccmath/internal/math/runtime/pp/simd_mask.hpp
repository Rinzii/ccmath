...
namespace ccm::pp
{
	...
	public:
		...
		CCM_ALWAYS_INLINE bool operator[](detail::SimdSizeType i) const { return Traits::mget(data_, i); }
		...
		CCM_ALWAYS_INLINE friend basic_simd_mask operator||(basic_simd_mask const & a, basic_simd_mask const & b)
		{ return from_member(Traits::mor(a.data_, b.data_)); }
		CCM_ALWAYS_INLINE basic_simd_mask operator!() const { return from_member(Traits::mnot(data_)); }
		CCM_ALWAYS_INLINE basic_simd_mask operator~() const { return from_member(Traits::mnot(data_)); }
