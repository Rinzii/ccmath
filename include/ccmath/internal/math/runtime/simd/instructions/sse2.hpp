...
namespace ccm::intrin
{
	...
	template <> struct simd_mask<float, abi::sse2>
	{
	...
	template <> struct simd<float, abi::sse2>
	{
	...
	template <> struct simd_mask<double, abi::sse2>
	{
		using value_type			  = bool;
	...
	template <> struct simd<double, abi::sse2> // NOLINT
	{
	...
	CCM_ALWAYS_INLINE simd<double, abi::sse2>
	choose(simd_mask<double, abi::sse2> const & a, simd<double, abi::sse2> const & b, simd<double, abi::sse2> const & c)
	{
		// NOLINTNEXTLINE(modernize-return-braced-init-list)
