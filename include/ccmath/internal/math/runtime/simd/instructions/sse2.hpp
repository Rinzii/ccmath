...
namespace ccm::intrin
{
	...
	struct simd<float, abi::sse2>
	{
		...
		static constexpr int size() { return 4; }
		CCM_ALWAYS_INLINE
		simd(float value) : m_value(_mm_set1_ps(value)) {} // NOLINT(google-explicit-constructor)
		CCM_ALWAYS_INLINE
	...
	struct simd<double, abi::sse2> // NOLINT
	{
		...
		CCM_ALWAYS_INLINE
		simd(double value) : m_value(_mm_set1_pd(value)) {} // NOLINT(google-explicit-constructor)
		CCM_ALWAYS_INLINE
