...
namespace ccm::intrin
{
	...
	CCM_ALWAYS_INLINE bool all_of(simd_mask<float, abi::sse3> const & a)
	{
		return _mm_movemask_ps(a.get()) == 0xF;
	}

	CCM_ALWAYS_INLINE bool any_of(simd_mask<float, abi::sse3> const & a)
	{
	...
	CCM_ALWAYS_INLINE bool all_of(simd_mask<double, abi::sse3> const & a)
	{
		return _mm_movemask_pd(a.get()) == 0x3;
	}

	CCM_ALWAYS_INLINE bool any_of(simd_mask<double, abi::sse3> const & a)
	{
	...
	struct simd<double, abi::sse3>
	{
		...
		CCM_ALWAYS_INLINE simd_mask<double, abi::sse3> operator<(simd const & other) const
		{
