...
namespace ccm::intrin
{
	...
	struct simd<float, abi::avx2>
	{
		...
		CCM_ALWAYS_INLINE simd_mask<float, abi::avx2> operator<(simd const & other) const { return {_mm256_cmp_ps(m_value, other.m_value, _CMP_LT_OS)}; }
		CCM_ALWAYS_INLINE simd_mask<float, abi::avx2> operator==(simd const & other) const { return {_mm256_cmp_ps(m_value, other.m_value, _CMP_EQ_OS)}; }
	...
	public:
		...
		CCM_ALWAYS_INLINE simd_mask<double, abi::avx2> operator<(simd const & other) const { return {_mm256_cmp_pd(m_value, other.m_value, _CMP_LT_OS)}; }
		CCM_ALWAYS_INLINE simd_mask<double, abi::avx2> operator==(simd const & other) const { return {_mm256_cmp_pd(m_value, other.m_value, _CMP_EQ_OS)}; }
