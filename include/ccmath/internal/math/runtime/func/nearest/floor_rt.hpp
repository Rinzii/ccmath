...
namespace ccm::rt
{
	...
	{
#if (CCM_HAS_BUILTIN(__builtin_floor) || defined(__builtin_floor)) && !defined(CCMATH_COMPILER_GCC)
		...
		{
			return static_cast<T>(__builtin_floorl(static_cast<long double>(num)));
		}
#else
