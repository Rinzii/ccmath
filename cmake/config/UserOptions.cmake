...
option(CCMATH_INSTALL
    "Setup install and package steps"
    ${is_root_project})

# CCMATH_BUILD_TESTS:
# Enable building of ccmath tests. If OFF, tests are skipped. Should only be used by ccmath developers.
option(CCMATH_BUILD_TESTS
    "Build ccmath tests"
    ${is_root_project})

# CCMATH_FIND_GTEST_PACKAGE:
# Look for gtest package rather than downloading it if needed.
option(CCMATH_FIND_GTEST_PACKAGE
    "Enable finding of gtest package"
    ON)

# CCMATH_BUILD_BENCHMARKS:
# Enable building of ccmath benchmarks. If OFF, benchmarks are skipped.
option(CCMATH_BUILD_BENCHMARKS
    "Build ccmath benchmarks"
    ${is_root_project})

# CCMATH_FIND_GBENCH_PACKAGE:
# Look for google benchmark package rather than downloading it if needed.
# Should only be used by ccmath developers.
option(CCMATH_FIND_GBENCH_PACKAGE
    "Enable finding of google benchmark package"
     ON)

# CCMATH_BUILD_EXAMPLES:
# Build example code demonstrating usage of ccmath.
option(CCMATH_BUILD_EXAMPLES
    "Build ccmath examples"
    ${is_root_project})

# CCMATH_ENABLE_USER_DEFINED_OPTIMIZATION_MACROS:
# Allow users to supply their own optimization macros rather
# than CCMath defining them itself.
...
# Disable usage of errno during runtime breaking standard compliance,
# but may lead to faster evaluation and smaller binaries.
...
option(CCMATH_ENABLE_AUTOFORMAT_SRC
    "Enable automatic source formatting using clang-format during the ccmath configuration"
     ON)
