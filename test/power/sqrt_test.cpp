...
{
	// Test values that are 2^x
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(0.0), std::sqrt(0.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(1.0), std::sqrt(1.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(2.0), std::sqrt(2.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(4.0), std::sqrt(4.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(8.0), std::sqrt(8.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(16.0), std::sqrt(16.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(32.0), std::sqrt(32.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(64.0), std::sqrt(64.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(128.0), std::sqrt(128.0));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(256.0), std::sqrt(256.0));

	// Test decimal values
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(0.1), std::sqrt(0.1));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(0.2), std::sqrt(0.2));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(0.3), std::sqrt(0.3));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(0.4), std::sqrt(0.4));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(0.5), std::sqrt(0.5));
}

TEST(CcmathPowerTests, Sqrt_RT_Double_EdgeCases)
{
	// Test edge cases
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(std::numeric_limits<double>::min()), std::sqrt(std::numeric_limits<double>::min()));
	EXPECT_EQ(ccm::support::math::rt::internal_sqrt_rt(std::numeric_limits<double>::max()), std::sqrt(std::numeric_limits<double>::max()));
