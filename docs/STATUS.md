...
| fabs           | 100    |                                                                                                                                                                                                  |
| fdim           | 100    |                                                                                                                                                                                                  |
| fma            | 100    | Native-first AArch64 runtime, exact software fallback for all modes, constexpr respects `CCM_CONSTEXPR_ROUNDING_MODE`. Wider x86_64 validation remains open.                                     |
| (f)max         | 100    |                                                                                                                                                                                                  |
| (f)min         | 100    |                                                                                                                                                                                                  |
| remainder      | 100    |                                                                                                                                                                                                  |
