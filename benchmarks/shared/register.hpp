...
#define CCMATH_BENCH_DECLARE_UNARY_COMPARE(Module, Name, StdBody, CcmBody) CCMATH_BENCH_DECLARE_UNARY_SUITE(Module, Name, , StdBody, CcmBody)

#define CCMATH_BENCH_REGISTER_UNARY_COMPARE(Module, Name) CCMATH_BENCH_REGISTER_UNARY_SUITE(Module, Name, )

#define CCMATH_BENCH_DECLARE_BINARY_COMPARE(Module, Name, StdBody, CcmBody) CCMATH_BENCH_DECLARE_BINARY_SUITE(Module, Name, , StdBody, CcmBody)

#define CCMATH_BENCH_REGISTER_BINARY_COMPARE(Module, Name) CCMATH_BENCH_REGISTER_BINARY_SUITE(Module, Name, )

#define CCMATH_BENCH_DECLARE_TERNARY_COMPARE(Module, Name, StdBody, CcmBody) CCMATH_BENCH_DECLARE_TERNARY_SUITE(Module, Name, , StdBody, CcmBody)
