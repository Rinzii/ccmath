...
namespace ccm::test::samples
{
	...
	inline constexpr std::array<double, 16> kPowExpGrid = {
		-10.0, -5.0, -3.0, -2.0, -1.5, -1.0, -0.5, -0.1, 0.1, 0.5, 1.0, 1.5, 2.0, 3.0, 5.0, 10.0,
	};

	inline constexpr std::array<float, 16> kPowExpGridFloat = {
		-10.0F, -5.0F, -3.0F, -2.0F, -1.5F, -1.0F, -0.5F, -0.1F, 0.1F, 0.5F, 1.0F, 1.5F, 2.0F, 3.0F, 5.0F, 10.0F,
	};
	...
	inline constexpr std::array<float, 16> kInvTrigUnitFloat = {
		-1.0F, -0.99F, -0.75F, -0.5F, -0.25F, -0.125F, -0.0F, 0.0F, 0.125F, 0.25F, 0.5F, 0.75F, 0.99F, 1.0F, 0x1.fffffep-1F, -0x1.fffffep-1F,
	};

	inline constexpr std::array<double, 16> kInvTrigUnitDouble = {
		-1.0, -0.99, -0.75, -0.5, -0.25, -0.125, -0.0, 0.0, 0.125, 0.25, 0.5, 0.75, 0.99, 1.0, 0x1.fffffffffffffp-1, -0x1.fffffffffffffp-1,
	};
	...
	inline constexpr std::array<float, 14> kCbrtFloat = {
		-27.0F, -8.0F, -1.0F, -0.0F, 0.0F, 0.125F, 1.0F, 8.0F, 27.0F, 64.0F, 1024.0F, 0x1.0p-126F, 0x1.0p+30F, -0x1.0p+30F,
	};
	...
	inline constexpr std::array<double, 24> kGammaProbeDouble = {
		0.125, 0.5,	  0.875, 1.5,  2.5,	 3.75,	4.5,   7.25,   10.0,	  12.5,		20.0,	   30.0,
		50.0,  100.0, -0.25, -1.5, -2.5, -3.25, -10.5, -15.25, 0x1.0p-20, 0x1.0p+4, 0x1.0p+10, 0x1.0p+20,
	};

	inline constexpr std::array<float, 16> kGammaProbeFloat = {
		0.125F, 0.5F, 1.5F, 2.5F, 3.75F, 7.25F, 10.0F, 20.0F, 50.0F, -0.25F, -1.5F, -2.5F, -10.5F, 0x1.0p-10F, 0x1.0p+4F, 0x1.0p+10F,
	};
