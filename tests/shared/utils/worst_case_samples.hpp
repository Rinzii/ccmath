...
namespace ccm::test::worst_case
{
	...
	inline constexpr std::array<float, 6> kSinFloatExceptional = {
		0x1.4f0654p0F, -0x1.4f0654p0F, 0x1.33333p13F, 0x1.fbd9c8p22F, 0x1.465d2p25F, 0x1.47d0fep+34F,
	};
	...
	inline constexpr std::array<float, 6> kExpm1FloatHard = {
		0x1.0p-25F, 0x1.0p-24F, 0x1.0p-2F, -0x1.0p-2F, 0x1.62e42ep6F, -0x1.9fe368p6F,
	};

	inline constexpr std::array<double, 7> kExpm1DoubleHard = {
		0x1.0p-54, 0x1.0p-53, 0x1.0p-2, -0x1.0p-2, 0x1.0p-10, 0x1.62e42ep+6, -0x1.62e42ep+6,
	};

	inline constexpr std::array<float, 5> kExpFloatHard = {
		0x1.0p-25F, 0x1.0p+0F, 0x1.62e42ep6F, -0x1.0p+1F, -0x1.9fe368p6F,
	};

	inline constexpr std::array<double, 5> kExpDoubleHard = {
		0x1.0p-54, 0x1.0p-1022, 0x1.0p+0, 0x1.62e42ep+6, -0x1.62e42ep+6,
	};
	...
	inline constexpr std::array<double, 5> kLogDoubleHard = {
		0x1.0000000000001p+0, 0x1.fffffffffffffp+0, 0x1.62a88613629b6p+0, 0x1.0p-1022, 0x1.0p+1023,
	};
	...
	inline constexpr std::array<float, 6> kLog1pFloatHard = {
		0x1.0p-25F, 0x1.0p-24F, 0x1.6a09e667f3bcdp-1F, -0x1.6a09e667f3bcdp-1F, -0x1.0p-1F, 0x1.0p+1F,
	};

	inline constexpr std::array<double, 6> kLog1pDoubleHard = {
		0x1.0p-53, 0x1.0p-52, 0x1.6a09e667f3bcdp-1, -0x1.6a09e667f3bcdp-1, -0x1.0p-1, 0x1.0p+4,
	};
	...
	inline constexpr std::array<double, 6> kAsinDoubleHard = {
		0x1.0p-1022, -0x1.0p-1022, 0x1.fffffffffffffp-1, -0x1.fffffffffffffp-1, 0x1.0p-27, -0x1.0p-27,
	};

	inline constexpr std::array<float, 5> kAsinFloatHard = {
		0x1.0p-126F, -0x1.0p-126F, 0x1.fffffep-1F, -0x1.fffffep-1F, 0x1.0p-14F,
	};

	inline constexpr std::array<double, 5> kAtanDoubleHard = {
		0x1.0p-1022, -0x1.0p-1022, 0x1.0p+300, -0x1.0p+300, 0x1.1p+0,
	};
	...
	inline constexpr std::array<double, 6> kCbrtDoubleHard = {
		0x1.0p-1022, -0x1.0p-1022, 0x1.fffffffffffffp+1023, -0x1.fffffffffffffp+1023, 0x1.428a2f98d728bp+0, -0x1.428a2f98d728bp+0,
	};

	inline constexpr std::array<float, 5> kCbrtFloatHard = {
		0x1.0p-126F, -0x1.0p-126F, 0x1.fffffep+127F, -0x1.fffffep+127F, 0x1.428a2fp+0F,
	};
	...
	inline constexpr std::array<double, 8> kGammaDoubleHard = {
		0x1.0p-27, 0x1.fffffffffffp-1, 0x1.0p+4, 0x1.0p+20, -0x1.0p-3, -0x1.8p+0, -0x1.0p+1, -0x1.0p+4,
	};
